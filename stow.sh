...
(cd home && find . -maxdepth 4 -type d -exec mkdir -vp "$U_HOME/{}" \;)
(cd local && find . -maxdepth 2 -type d -exec mkdir -vp "$U_HOME/.local/{}" \;)
(cd config && find . -maxdepth 2 -type d -exec mkdir -vp "$U_HOME/.config/{}" \;)
